...
/**
 * Created by tilo on 1/20/16.
 */
public class SimpleConsumerRunnable implements Callable<Integer> {
    ...
    public SimpleConsumerRunnable(List<String> seedBrokers, int port, String topic, int partition, int threadnumber, long max_reads) {
        this.a_seedBrokers = seedBrokers;
        this.a_port = port;
        this.a_topic = topic;
        this.a_partition = partition;
        this.a_threadnumber = threadnumber;
        this.a_maxReads = max_reads;
